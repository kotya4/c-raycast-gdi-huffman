// c stands for Compressor. Compresses images using imgs and generates imge.
...
main () {
  ...
  if ( !f ) {
    ...
    fprintf ( f, "// e stands for Encoded. Use this file in imgd to generate textures\n" );
